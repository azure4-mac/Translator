...
void main() {
  runApp(
    MaterialApp(debugShowCheckedModeBanner: false, home: AppTranslator()),
  );
}

class AppTranslator extends StatefulWidget {AppTranslator({Key});
  @override
...
FutureOr<void> translateText() async {
  ...
  final translation = await translator.translate(input, to: _selectedLanguage);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text('Tradução:', style: TextStyle(fontWeight: FontWeight.bold)),Text(translatedText),
